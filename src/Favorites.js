...
export class FavoritesView extends Favorites {
  ...
  createRow() {
    ...
    <div class="user">
      <img
        src="https://avatars.githubusercontent.com/u/123831652?v=4"
        alt="Imagem de Anny Guimaraes"
      />
      <a href="https://github.com/Annygmelo" target="_blank">
        <p>Anny Guimarães</p>
        <span>Anny Guimarães</span>
      </a>
    </div>
  </td>
